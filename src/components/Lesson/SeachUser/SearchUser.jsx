  ...
  return (
    <div className="SearchUser">
      <h2 className="mt-20 mx-60 text-black-100 antialiased font-mono text-3xl">
        Welcome {name}, <span style={{ marginLeft: "10px" }}></span>search
        GitHub for your favorite developer!
      </h2>
      <br />
      <div className="mt-40 mx-16">
        <input
          ...
          className="ml-96 px-3 py-3 placeholder-blueGray-200  text-blueGray-600 relative bg-white bg-white rounded text-sm border-2 border-black-300 outline-none focus:outline-none focus:ring w-4/12"
